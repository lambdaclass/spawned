use crate::threads::{
    send_interval, RequestResult, MessageResult, Actor, ActorRef, InitResult,
};
...
impl Actor for Delayed {
    ...
    fn handle_message(&mut self, message: Self::Message, _handle: &DelayedHandle) -> MessageResult {
        match message {
